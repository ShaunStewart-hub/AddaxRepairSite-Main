...
export default function Header() {
  ...
  return (
    <header>
      ...
      <hr />
      <section>
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 pt-4 pb-4 h-36">
          <a
          ...
          >
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-20xl font-semibold whitespace-nowrap dark:text-white">
              Addax Tech Repairs
            </span>
          </a>

          <div class="">
            <ul class="flex rounded-lg  flex-row md:space-x-8">
              <li>
                <HorizontalVideoCard
                  text={text.phone}
                  src={icon.phone}
